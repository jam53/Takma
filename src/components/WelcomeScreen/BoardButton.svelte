<script lang="ts">
    ...
    export let updateWelcomeScreenFunction;
    ...
    /**
     * This function gets called when we click on the favourite icon AKA start icon of a board
     */
