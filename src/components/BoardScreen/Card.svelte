            ...
            <div class="icons">
                {#if card.dueDate !== null}
                    <div class="dueDate"
                         ...
                         title={new Date(parseInt(card.dueDate)).toLocaleString("default", {dateStyle: "full", timeStyle: "short", hourCycle: "h23"})}
                    >
                        ...
                        <div style="white-space: nowrap; overflow: hidden">
                            {`${(new Date(parseInt(card.dueDate))).toLocaleString("default", {minute: "numeric", hour: "numeric", hourCycle: "h23", day: "numeric", month: "long"})}`}
                        </div>
                    </div>
                {/if}
                {#if card.description !== ""}
