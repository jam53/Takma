...
<div id="createNewCardDiv" class="newCard" bind:this={createNewCardDiv} on:click={openCreateNewCard} use:clickOutside on:click_outside={closeCreateNewCard} on:contextmenu|stopPropagation on:drop|stopPropagation|preventDefault>
