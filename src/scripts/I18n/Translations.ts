...
export let en: Translation = {
    ...
    storeDataAppFolder: "Takma will store its data in the application data folder (<code>$|00|$</code>) on your device.",
    ...
    code: "Inline Code",
    quote: "Quote",
    genericList: "Unordered List",
    numberedList: "Ordered List",
    createLink: "Create Link",
    insertImage: "Insert Image",
    importImage: "Import an image",
    insertTable: "Insert Table",
    insertHorizontalLine: "Horizontal rule",
    ...
    setImageUsingUrl: "Set image using URL",
    setImageUsingFile: "Set image using file",
    collapsibleSection: "Collapsible Section",
    setLink: "Set Link",
    unsetLink: "Unset Link",
    setTextColor: "Set text color",
    unsetTextColor: "Unset color",
    row: "Row",
    column: "Column",
    ...
    confirmChangeSaveLocationTitle: "Change Takma's save location?",
...
export let ar: Translation = {
    ...
    default: "افتراضي",
    appDataFolder: "مجلد بيانات التطبيق",
    storeDataAppFolder: "سوف تخزن تكما بياناتها في مجلد بيانات التطبيق (<code>$|00|$</code>) على جهازك.",
    ...
    setImageUsingUrl: "إدراج صورة باستخدام الرابط",
    setImageUsingFile: "إدراج صورة من ملف",
    collapsibleSection: "قسم قابل للطي",
    setLink: "إضافة رابط",
    unsetLink: "إزالة الرابط",
    setTextColor: "تعيين لون النص",
    unsetTextColor: "إزالة اللون",
    row: "صف",
    column: "عمود",
    deleteRow: "حذف الصف",
    deleteColumn: "حذف العمود",
    deleteTable: "حذف الجدول",
    changeSaveLocation: "تغيير موقع الحفظ",
    confirmChangeSaveLocationTitle: "هل تريد تغيير موقع حفظ Takma؟",
...
export let de: Translation = {
    ...
    default: "Standard",
    appDataFolder: "App-Datenordner",
    storeDataAppFolder: "Takma speichert seine Daten im App-Datenordner (<code>$|00|$</code>) auf deinem Gerät.",
    ...
    codeBlock: "Codeblock",
    setImageUsingUrl: "Bild über URL einfügen",
    setImageUsingFile: "Bild aus Datei einfügen",
    collapsibleSection: "Einklappbarer Abschnitt",
    setLink: "Link setzen",
    unsetLink: "Link entfernen",
    setTextColor: "Textfarbe festlegen",
    unsetTextColor: "Farbe entfernen",
    row: "Zeile",
    column: "Spalte",
    deleteRow: "Zeile löschen",
    deleteColumn: "Spalte löschen",
    deleteTable: "Tabelle löschen",
    changeSaveLocation: "Speicherort ändern",
    confirmChangeSaveLocationTitle: "Takmas Speicherort ändern?",
...
export let es: Translation = {
    ...
    appDataFolder: "Carpeta de datos de la aplicación",
    storeDataAppFolder: "Takma almacenará sus datos en la carpeta de datos de la aplicación (<code>$|00|$</code>) en su dispositivo.",
    ...
    setImageUsingUrl: "Insertar imagen desde URL",
    setImageUsingFile: "Insertar imagen desde archivo",
    collapsibleSection: "Sección plegable",
    setLink: "Establecer enlace",
    unsetLink: "Quitar enlace",
    setTextColor: "Establecer color de texto",
    unsetTextColor: "Quitar color",
    row: "Fila",
    column: "Columna",
    deleteRow: "Eliminar Fila",
    deleteColumn: "Eliminar Columna",
    deleteTable: "Eliminar Tabla",
    changeSaveLocation: "Cambiar ubicación de guardado",
    confirmChangeSaveLocationTitle: "¿Cambiar la ubicación de guardado de Takma?",
...
export let et: Translation = {
    ...
    default: "Vaikimisi",
    appDataFolder: "Rakenduse andmete kaust",
    storeDataAppFolder: "Takma salvestab oma andmed teie seadme rakenduse andmete kausta (<code>$|00|$</code>).",
    ...
    failedToCopyToClipboard: "Lõikelauale kopeerimine ebaõnnestus",
    codeBlock: "Koodiplokk",
    setImageUsingUrl: "Määra pilt URL-i abil",
    setImageUsingFile: "Määra pilt failist",
    collapsibleSection: "Ahendatav jaotis",
    setLink: "Määra link",
    unsetLink: "Eemalda link",
    setTextColor: "Määra teksti värv",
    unsetTextColor: "Eemalda värv",
    row: "Rida",
    column: "Veerg",
    deleteRow: "Kustuta rida",
    deleteColumn: "Kustuta veerg",
    deleteTable: "Kustuta tabel",
    changeSaveLocation: "Muuda salvestuskohta",
    confirmChangeSaveLocationTitle: "Kas muuta Takma salvestuskohta?",
...
export let fr: Translation = {
    ...
    default: "Par défaut",
    appDataFolder: "Dossier des données de l'application",
    storeDataAppFolder: "Takma stockera ses données dans le dossier des données de l'application (<code>$|00|$</code>) sur votre appareil.",
    ...
    setImageUsingUrl: "Insérer une image depuis une URL",
    setImageUsingFile: "Insérer une image depuis un fichier",
    collapsibleSection: "Section réductible",
    setLink: "Définir le lien",
    unsetLink: "Supprimer le lien",
    setTextColor: "Définir la couleur du texte",
    unsetTextColor: "Supprimer la couleur",
    row: "Ligne",
    column: "Colonne",
    deleteRow: "Supprimer la ligne",
    deleteColumn: "Supprimer la colonne",
    deleteTable: "Supprimer le tableau",
    changeSaveLocation: "Changer l'emplacement de sauvegarde",
    confirmChangeSaveLocationTitle: "Changer l'emplacement de sauvegarde de Takma ?",
...
export let hi: Translation = {
    ...
    default: "डिफ़ॉल्ट",
    appDataFolder: "ऐप डेटा फ़ोल्डर",
    storeDataAppFolder: "तकमा अपने डेटा को आपके डिवाइस के ऐप डेटा फ़ोल्डर (<code>$|00|$</code>) में स्टोर करेगा।",
    ...
    codeBlock: "कोड ब्लॉक",
    setImageUsingUrl: "URL का उपयोग करके छवि सेट करें",
    setImageUsingFile: "फ़ाइल का उपयोग करके छवि सेट करें",
    collapsibleSection: "संकेतन योग्य अनुभाग",
    setLink: "लिंक सेट करें",
    unsetLink: "लिंक हटाएं",
    setTextColor: "टेक्स्ट का रंग सेट करें",
    unsetTextColor: "रंग हटाएं",
    row: "पंक्ति",
    column: "कॉलम",
    deleteRow: "पंक्ति हटाएं",
    deleteColumn: "कॉलम हटाएं",
    deleteTable: "तालिका हटाएं",
    changeSaveLocation: "सेव लोकेशन बदलें",
    confirmChangeSaveLocationTitle: "Takma की सेव लोकेशन बदलें?",
...
export let id: Translation = {
    ...
    default: "Default",
    appDataFolder: "Folder Data Aplikasi",
    storeDataAppFolder: "Takma akan menyimpan datanya di folder data aplikasi (<code>$|00|$</code>) pada perangkat Anda.",
    ...
    codeBlock: "Blok Kode",
    setImageUsingUrl: "Atur gambar menggunakan URL",
    setImageUsingFile: "Atur gambar menggunakan file",
    collapsibleSection: "Bagian Ciutkan",
    setLink: "Atur Tautan",
    unsetLink: "Batalkan Tautan",
    setTextColor: "Atur warna teks",
    unsetTextColor: "Batalkan warna",
    row: "Baris",
    column: "Kolom",
    deleteRow: "Hapus Baris",
    deleteColumn: "Hapus Kolom",
    deleteTable: "Hapus Tabel",
    changeSaveLocation: "Ubah lokasi penyimpanan",
    confirmChangeSaveLocationTitle: "Ubah lokasi penyimpanan Takma?",
...
export let ja: Translation = {
    ...
    default: "デフォルト",
    appDataFolder: "アプリデータフォルダ",
    storeDataAppFolder: "Takmaはデータをデバイスのアプリデータフォルダ（<code>$|00|$</code>）に保存します。",
    ...
    codeBlock: "コードブロック",
    setImageUsingUrl: "URLを使用して画像を設定",
    setImageUsingFile: "ファイルを使用して画像を設定",
    ...
    deleteColumn: "列を削除",
    deleteTable: "表を削除",
    changeSaveLocation: "保存場所の変更",
    confirmChangeSaveLocationTitle: "Takmaの保存場所を変更しますか？",
...
export let ko: Translation = {
    ...
    filterCards: "카드 필터링",
    default: "기본값",
    appDataFolder: "앱 데이터 폴더",
    storeDataAppFolder: "Takma는 데이터를 기기의 앱 데이터 폴더(<code>$|00|$</code>)에 저장합니다.",
    ...
    codeBlock: "코드 블록",
    setImageUsingUrl: "URL을 사용하여 이미지 설정",
    setImageUsingFile: "파일을 사용하여 이미지 설정",
    collapsibleSection: "접을 수 있는 섹션",
    setLink: "링크 설정",
    unsetLink: "링크 해제",
    setTextColor: "텍스트 색상 설정",
    unsetTextColor: "색상 해제",
    row: "행",
    column: "열",
    deleteRow: "행 삭제",
    deleteColumn: "열 삭제",
    deleteTable: "표 삭제",
    changeSaveLocation: "저장 위치 변경",
    confirmChangeSaveLocationTitle: "Takma의 저장 위치를 변경하시겠습니까?",
...
export let nl: Translation = {
    ...
    default: "Standaard",
    appDataFolder: "App-gegevensmap",
    storeDataAppFolder: "Takma zal zijn gegevens opslaan in de app-gegevensmap (<code>$|00|$</code>) op je apparaat.",
    ...
    codeBlock: "Codeblok",
    setImageUsingUrl: "Afbeelding instellen via URL",
    setImageUsingFile: "Afbeelding instellen vanuit bestand",
    collapsibleSection: "Inklapbare sectie",
    setLink: "Link instellen",
    unsetLink: "Link verwijderen",
    setTextColor: "Tekstkleur instellen",
    unsetTextColor: "Kleur verwijderen",
    row: "Rij",
    column: "Kolom",
    deleteRow: "Rij verwijderen",
    deleteColumn: "Kolom verwijderen",
    deleteTable: "Tabel verwijderen",
    changeSaveLocation: "Opslaglocatie wijzigen",
    confirmChangeSaveLocationTitle: "Opslaglocatie van Takma wijzigen?",
...
export let pt: Translation = {
    ...
    default: "Padrão",
    appDataFolder: "Pasta de dados do aplicativo",
    storeDataAppFolder: "O Takma armazenará seus dados na pasta de dados do aplicativo (<code>$|00|$</code>) no seu dispositivo.",
    ...
    setImageUsingUrl: "Definir imagem usando URL",
    setImageUsingFile: "Definir imagem usando arquivo",
    collapsibleSection: "Seção Recolhível",
    setLink: "Definir Link",
    unsetLink: "Remover Link",
    setTextColor: "Definir cor do texto",
    unsetTextColor: "Remover cor",
    row: "Linha",
    column: "Coluna",
    deleteRow: "Excluir Linha",
    deleteColumn: "Excluir Coluna",
    deleteTable: "Excluir Tabela",
    changeSaveLocation: "Alterar local de salvamento",
    confirmChangeSaveLocationTitle: "Alterar local de salvamento do Takma?",
...
export let ru: Translation = {
    ...
    appDataFolder: "Папка данных приложения",
    storeDataAppFolder: "Takma будет хранить свои данные в папке данных приложения (<code>$|00|$</code>) на вашем устройстве.",
    ...
    codeBlock: "Блок кода",
    setImageUsingUrl: "Вставить изображение по URL",
    setImageUsingFile: "Вставить изображение из файла",
    collapsibleSection: "Сворачиваемый раздел",
    setLink: "Установить ссылку",
    unsetLink: "Удалить ссылку",
    setTextColor: "Установить цвет текста",
    unsetTextColor: "Убрать цвет",
    row: "Строка",
    column: "Столбец",
    deleteRow: "Удалить строку",
    deleteColumn: "Удалить столбец",
    deleteTable: "Удалить таблицу",
    changeSaveLocation: "Изменить место сохранения",
    confirmChangeSaveLocationTitle: "Изменить место сохранения Takma?",
...
export let tr: Translation = {
    ...
    default: "Varsayılan",
    appDataFolder: "Uygulama Verileri Klasörü",
    storeDataAppFolder: "Takma verilerini cihazınızdaki uygulama verileri klasöründe (<code>$|00|$</code>) saklayacak.",
    ...
    codeBlock: "Kod Bloğu",
    setImageUsingUrl: "URL kullanarak resim ayarla",
    setImageUsingFile: "Dosya kullanarak resim ayarla",
    collapsibleSection: "Daraltılabilir Bölüm",
    setLink: "Bağlantı Ayarla",
    unsetLink: "Bağlantıyı Kaldır",
    setTextColor: "Metin rengini ayarla",
    unsetTextColor: "Rengi kaldır",
    row: "Satır",
    column: "Sütun",
    deleteRow: "Satırı Sil",
    deleteColumn: "Sütunu Sil",
    deleteTable: "Tabloyu Sil",
    changeSaveLocation: "Kayıt konumunu değiştir",
    confirmChangeSaveLocationTitle: "Takma'nın kayıt konumu değiştirilsin mi?",
...
export let zh: Translation = {
    ...
    filterCards: "筛选卡片",
    default: "默认",
    appDataFolder: "应用数据文件夹",
    storeDataAppFolder: "Takma 将其数据存储在您设备的应用数据文件夹 (<code>$|00|$</code>) 中。",
    ...
    failedToCopyToClipboard: "无法复制到剪贴板",
    codeBlock: "代码块",
    setImageUsingUrl: "使用URL设置图像",
    setImageUsingFile: "使用文件设置图像",
    ...
    confirmChangeSaveLocationTitle: "更改 Takma 的保存位置吗？",
